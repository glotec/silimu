CREATE DATABASE  IF NOT EXISTS `silimu` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `silimu`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: localhost    Database: silimu
-- ------------------------------------------------------
...
CREATE TABLE `details` (
  ...
  `person` varchar(7) DEFAULT NULL,
  `fonctiion` varchar(7) DEFAULT NULL,
...
CREATE TABLE `ville` (
  ...
  PRIMARY KEY (`id`),
  KEY `addr_idx` (`address`),
  CONSTRAINT `addr` FOREIGN KEY (`address`) REFERENCES `address` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-07-11 23:18:11
