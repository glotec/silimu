<?php require_once 'conf/allagent.conf.php'; ?>
<div class="row">
  <div class="col-md-8">
    <h2 class="sub-header text-center">Impression des cartes</h2>
<div class="">
    ...
    <tbody>
      <?php while ($row = mysqli_fetch_assoc($res)) {?>
        <tr>
          ...
          <td><a href="index.php?page=printcard&id=<?=$row['id']?>" class="btn btn-success">Imprimer</a></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
