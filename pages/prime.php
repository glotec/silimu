<?php require_once 'conf/prime.conf.php' ?>
<div class="row">
  <div class="col-md-4">
    <h2 class="sub-header text-center">Rapport par prime</h2>
  </div>
  <div class="col-md-6">
    <form action="" method="post" class="navbar-form navbar-right">
        ...
        <!-- <label for="password">Gender</label> -->
            <select name="matr" class="form-control item-center" id="gender">
                ...
                <option value="prime">Agents primés</option>
                <option value="sansprime">Agents non-primés</option>
            </select>
