<?php require_once 'conf/salaire.conf.php' ?>
<div class="row">
  <div class="col-md-4">
    <h2 class="sub-header text-center">Rapport par salaire</h2>
  </div>
  <div class="col-md-6">
    <form action="" method="post" class="navbar-form navbar-right">
        ...
        <!-- <label for="password">Gender</label> -->
            <select name="matr" class="form-control item-center" id="gender">
                ...
                <option value="salaire">Agents salariés</option>
                <option value="sanssal">Agents non-salariés</option>
            </select>
